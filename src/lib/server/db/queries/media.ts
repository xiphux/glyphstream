 ...
 */
export const assignedConversationId = sql<
	string | null
 ...
 */
export function attachConversationTitles<
...
export function getMediaListItemsByIds(userId: string, ids: string[]): MediaListItem[] {
