...
- Never assign a subject an attribute the user left unstated — GENDER above all. If they wrote "a figure", "a rider", "a person", keep it as they wrote it. Inventing a gender is changing the subject, not formatting it.
