...
<div
	role="status"
	aria-live="polite"
	class="fixed bottom-4 left-1/2 z-update flex max-w-[calc(100vw-2rem)] -translate-x-1/2 items-center gap-2 rounded-full border border-border surface-glass px-3 py-2 text-sm shadow-lg"
